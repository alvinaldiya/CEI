    ...
    <div id="main-container">
        <div id="main-content" class="main-content container">
                                ...
                                <form method="get" action="login/google" name="login_form">
                                    <fieldset>
                                        <div class="controls controls-row">
                                            <button id="tes" type="submit" class="span4 btn btn-yellow btn-large">Login With Google</button>
                                        </div>
                                        <hr class="margin-xm">
                                    </fieldset>
                                </form>
            ...
            @if(Session::has('message'))
                <div id="failedMessage" class="alert alert-danger alert-content">
                    <!-- <button type="button" class="close" data-dismiss="alert">×</button> -->
                    <strong>Perhatian!</strong> Email anda tidak terdaftar <!-- <code>.alert-content</code> -->.
                </div>
            @endif

            @if (session('status'))
                        <div id="successMessage" class="alert alert-success alert-content">
                            {{ session('status') }}
                        </div>
                    @endif
                    @if (session('warning'))
                        <div id="warningMessage" class="alert alert-warning alert-content">
                            {{ session('warning') }}
                        </div>
                    @endif
