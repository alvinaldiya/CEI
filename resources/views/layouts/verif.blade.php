                                  ...
                                  <div class="section-content">
                                      ...
                                      <table class="table table-striped table-condensed table-content boo-table">
                                          ...
                                          <tbody>
                                              <tr>
                                                  <td>ID</td>
                                                  <td>{{$data_sertifikat->id}}</td>
                                              </tr>
                                              <tr>
                                                  <td>No Sertifikat</td>
                                                  <td><span>{{$data_sertifikat->no_urut}}</span></td>
                                              </tr>
                                              <tr>
                                                  <td>Nama</td>
                                                  <td>{{strtoupper($data_sertifikat->nama)}}</td>
                                              </tr>
                                              <tr>
                                                  <td>Kegiatan</td>
                                                  <td>{{$data_sertifikat->judul_acara}}</td>
                                              </tr>
                                              <tr>
                                                  <td>Tanggal</td>
                                                  <td>{{$data_sertifikat->tgl_kegiatan}}</td>
                                              </tr>
                                          </tbody>
                                      </table>
                                      <br>
